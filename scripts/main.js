  ...
  const app = Vue.createApp({
    ...
    data() {
      return {
        ...
        skillsItems: [{
          imgUrl: '/assets/images/icons/html-5.png',
          title: 'HTML5'
        }, {
          imgUrl: '/assets/images/icons/css-3.png',
          title: 'CSS3'
        }, {
          ...
          imgUrl: 'https://nafie.webrouk.com/html/assets/images/skills/vue.png',
          title: 'Vue'
        }, {
          imgUrl: 'https://nafie.webrouk.com/html/assets/images/skills/react.png',
          title: 'React'
        }, {
          imgUrl: '/assets/images/icons/php.png',
          title: 'Php'
        }, {
          imgUrl: '/assets/images/icons/mysql.png',
          title: 'MySql'
        }, {
          imgUrl: '/assets/images/icons/wordpress.png',
          title: 'Wordpress'
        }, {
          imgUrl: '/assets/images/icons/docker.png',
          title: 'Docker'
        }],
        ...
        experienceItems: [{
          ...
          desc: {
            en: 'Atuava como freelancer em sites e e-mails marketing para pequenos clientes.',
            ar: 'مراقبة الجوانب الفنية لتطوير الواجهات الأمامية للمشاريع.'
          }
        }, {
          date: '2007',
          companyName: {
            en: 'Taho Telefonia Voip',
            ar: 'شركة فيسبوك'
          },
          jobTitle: {
            en: 'Webdesigner Junior',
            ar: 'مطوّر الويب المتكامل'
          },
          desc: {
            en: 'Primeira experiência como junior em uma empresa de médio porte. Atuava como desenvolvedor de interfaces para sistemas e manutenção no website.',
          ...
          desc: {
            en: 'Meu primeiro trabalho para empresas de grande porte. Nessa agencia desenvolvi trabalhos para Petrobrás, Shell, Tim, Shopping Rio Design, e outras.',
          ...
          jobTitle: {
            en: 'Mid Front-End Developer',
            ar: 'مطور الواجهة الأمامية'
          },
          desc: {
            en: 'Trabalhei no desenvolvimento Javascript dos produtos da empresa. Tive um marco bem significativo nessa empresa devido a minha evolução no Javascript.',
            ar: 'مراقبة الجوانب الفنية لتطوير الواجهات الأمامية للمشاريع.'
          }
        }, {
          date: '2012',
          companyName: {
            en: 'Telecom Rio Group',
            ar: 'شركة فيسبوك'
          },
          jobTitle: {
            en: 'Head of Front End Developer',
            ar: 'مطوّر الويب المتكامل'
          },
          desc: {
            en: 'Atuei durante 6 anos em uma empresa multinacional onde desenvolvi o sistema de visto americano para três países e outros produtos da empresa que foram homologados e colocados em produção em quatro continentes.',
            ar: 'تعاونت مع الفرق الإبداعية في تطوير وتنفيذ أفكار مبتكرة.'
          }
        }, {
          date: '2017',
          ...
          desc: {
            en: 'Atuei em projetos lindíssimos como o site do Janeiro Hotel e tive uma atuação muito especial em um grande cliente americano. Forte uso de React nos projetos.',
            ar: 'مراقبة الجوانب الفنية لتطوير الواجهات الأمامية للمشاريع.'
          }
        }, {
          date: '2019',
          ...
          desc: {
            en: 'Atuei em uma célula ágil onde era o responsável pelo front end do sistema de abertura de sinistros auto e residencial. Forte atuação com React e Vue para a maior seguradora do país.',
            ar: 'تعاونت مع الفرق الإبداعية في تطوير وتنفيذ أفكار مبتكرة.'
          }
        }, {
          date: '2020',
          ...
          desc: {
            en: 'Atuei na plataforma de pagamento de uma das maiores startups do país com soluções em ensino online. Atuei fortemente com aplicações Vue e Testes automatizados.',
            ar: 'تعاونت مع الفرق الإبداعية في تطوير وتنفيذ أفكار مبتكرة.'
          }
        },
        {
          ...
          desc: {
            en: 'Lidero um projeto de transformação digital do produto de chat. Atuo na área de desenvolvedor front-end para o sistema do cliente do ChatGuru. Estamos transformando todo o sistema legado em microaplicações Vue com Testes automatizados.',
            ar: 'تعاونت مع الفرق الإبداعية في تطوير وتنفيذ أفكار مبتكرة.'
          }
        },{}],
