 ...
 */
function villenoir_wc_memberships_members_only_product_notice() {
...
//add_action( 'woocommerce_before_single_product', 'villenoir_wc_memberships_members_only_product_notice' );