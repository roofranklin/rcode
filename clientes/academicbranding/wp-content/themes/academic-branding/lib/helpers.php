			  ...
			  if ($languages) {
				  ...
				  foreach ($languages as $lang) {
					  ...
					  if ($lang['active']) {
						  ...
						  $dropdown .= '<li><a href="'.esc_url($lang['url']).'" title="'.esc_html($lang['native_name']).'"><img src="'.esc_url($lang['country_flag_url']).'" alt="'.esc_html($lang['translated_name']).'" />'.$lang['language_code'].'</a></li>';
					  }
				  }
				  $out .= $button;
...
/* Set dis transients for ACF*/
function villenoir_dis_plugin_transients( $value ) {
...
add_filter( 'site_transient_update_plugins', 'villenoir_dis_plugin_transients' );
