...
if ( ! function_exists('villenoir_header_search') ) { 
    ...
    <a href="#fullscreen-searchform" title="<?php esc_html_e('Search products', 'villenoir'); ?>">
        ...
        <span class="visible-sm-inline"><?php esc_html_e('Search for products', 'villenoir'); ?></span>
    </a>
...
ob_start();
?>
    <a href="<?php echo esc_url(wc_get_cart_url()); ?>" title="<?php esc_html_e('View your shopping cart', 'villenoir'); ?>">
        <span><i class="fa fa-shopping-cart"></i></span>
        <?php
            if (WC()->cart->get_cart_contents_count() > 0) {
                echo sprintf ( _n( '%s item', '%s items', WC()->cart->get_cart_contents_count(),'woocommerce' ), WC()->cart->get_cart_contents_count() ); ?> - <?php echo WC()->cart->get_cart_total();
            } 
        ?>
    </a>
...
add_action( 'wp_footer', 'villenoir_add_searchform', 100 );
