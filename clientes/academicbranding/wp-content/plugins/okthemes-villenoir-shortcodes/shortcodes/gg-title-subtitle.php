...
vc_map( array(
   ...
   "params" => array(
	...
	array(
	  ...
	  array(
		 "type" => "checkbox",
		 "heading" => esc_html__("Add subtitle?", "okthemes-villenoir-shortcodes"),
		 "value" => array(esc_html__("Yes, please", "okthemes-villenoir-shortcodes") => "use_subtitle" ),
		 "param_name" => "add_subtitle"
	  ),
	  array(
		 "type" => "textarea",
		 "heading" => esc_html__("Subtitle", "okthemes-villenoir-shortcodes"),
		 "param_name" => "subtitle",
		 "admin_label" => true,
		 "description" => esc_html__("Insert the subtitle here", "okthemes-villenoir-shortcodes"),
