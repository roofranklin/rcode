 ...
 * @since 1.0.0
 */
class BLO_Icon_Controler extends Elementor\Base_Data_Control {
	...
	public static function get_icons() {
		...
		$icons = array(
                  'icon icon-strategicservices_icon1' => 'icon icon-strategicservices_icon1',
                  'icon icon-strategicservices_icon3' => 'icon icon-strategicservices_icon3',
                  'icon icon-strategicservices_icon4' => 'icon icon-strategicservices_icon4',
                  'icon icon-strategicservices_icon5' => 'icon icon-strategicservices_icon5',
                  'icon icon-strategicservices_icon6' => 'icon icon-strategicservices_icon6',
                  'icon icon-strategicservices_icon7' => 'icon icon-strategicservices_icon7',
                  'icon icon-strategicservices_icon8' => 'icon icon-strategicservices_icon8',
                  'icon icon-post_icon1' => 'icon icon-post_icon1',
                  'icon icon-post_icon2' => 'icon icon-post_icon2',
                  'icon icon-post_icon3' => 'icon icon-post_icon3',
                  'icon icon-post_icon4' => 'icon icon-post_icon4',
                  'icon icon-post_icon5' => 'icon icon-post_icon5',
                  'icon icon-application_icon' => 'icon icon-application_icon',
                  'icon icon-opened_positions_icon1' => 'icon icon-opened_positions_icon1',
                  'icon icon-opened_positions_icon2' => 'icon icon-opened_positions_icon2',
                  'icon icon-about_us_icon1' => 'icon icon-about_us_icon1',
                  'icon icon-about_us_icon2' => 'icon icon-about_us_icon2',
                  'icon icon-about_us_icon3' => 'icon icon-about_us_icon3',
                  'icon icon-about_us_icon4' => 'icon icon-about_us_icon4',
                  'icon icon-About-2' => 'icon icon-About-2',
                  'icon icon-About-3' => 'icon icon-About-3',
                  'icon icon-About-4' => 'icon icon-About-4',
                  'icon icon-About' => 'icon icon-About',
                  'icon icon-Banner_current' => 'icon icon-Banner_current',
                  'icon icon-Banner_factory-1' => 'icon icon-Banner_factory-1',
                  'icon icon-Banner_factory' => 'icon icon-Banner_factory',
                  'icon icon-Banner_pumpjack' => 'icon icon-Banner_pumpjack',
                  'icon icon-Funfacts-2' => 'icon icon-Funfacts-2',
                  'icon icon-Funfacts-3' => 'icon icon-Funfacts-3',
                  'icon icon-Funfacts-4' => 'icon icon-Funfacts-4',
                  'icon icon-Funfacts' => 'icon icon-Funfacts',
                  ...
                  'xsicon xsicon-arrow-alt-circle-right' => 'xsicon xsicon-arrow-alt-circle-right',
		);
	...
	public function content_template() {
		...
		<div class="elementor-control-field">
			...
			<div class="elementor-control-input-wrapper">
				...
				<select class="elementor-control-icon" data-setting="{{ data.name }}" data-placeholder="<?php esc_attr_e( 'Select Icon', 'blo' ); ?>">

					<option value=""><?php esc_html_e( 'Select Icon', 'blo' ); ?></option>
