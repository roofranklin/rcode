...
class FW_Option_Type_NewIcon extends FW_Option_Type {
	...
	protected function _enqueue_static( $id, $option, $data ) {
		...
		$uri = BLO_THEME_URI . '/components/option-types/' . $this->get_type() . '/static';
	...
	protected function _render( $id, $option, $data ) {
		...
		return fw_render_view( BLO_COMPONENTS . '/option-types/' . $this->get_type() . '/view.php', compact( 'id', 'option', 'data', 'set' ) );
	}
	...
	private function generate_unknown_set( $icon ) {
		return array(
			...
			'container-class'	 => '',
			'groups'			 => array(
				'unknown' => esc_html__( 'Unknown Set', 'blo' ),
			),
			'icons'				 => array(
	...
	private function get_default_sets() {
		return array(
			'font-awesome' => array( // http://fortawesome.github.io/Font-Awesome/icons
				...
				'groups'			 => array(
					'web-application'	 => esc_html__( 'Web Application Icons', 'blo' ),
					'hand'				 => esc_html__( 'Hand Icons', 'blo' ),
					'transportation'	 => esc_html__( 'Transportation Icons', 'blo' ),
					'gender'			 => esc_html__( 'Gender Icons', 'blo' ),
					'file-type'			 => esc_html__( 'File Type Icons', 'blo' ),
					'payment'			 => esc_html__( 'Payment Icons', 'blo' ),
					'currency'			 => esc_html__( 'Currency Icons', 'blo' ),
					'text-editor'		 => esc_html__( 'Text Editor Icons', 'blo' ),
					'directional'		 => esc_html__( 'Directional Icons', 'blo' ),
					'video-player'		 => esc_html__( 'Video Player Icons', 'blo' ),
					'brand'				 => esc_html__( 'Brand Icons', 'blo' ),
					'medical'			 => esc_html__( 'Medical Icons', 'blo' ),
					'blo-icons'	 => esc_html__( 'blo Icons', 'blo' ),
				),
				'icons'				 => array(
					...
					//blo Icons
					'icon icon-strategicservices_icon1' => array('group' => 'blo-icons'),
					'icon icon-strategicservices_icon3' => array('group' => 'blo-icons'),
					'icon icon-strategicservices_icon4' => array('group' => 'blo-icons'),
					'icon icon-strategicservices_icon5' => array('group' => 'blo-icons'),
					'icon icon-strategicservices_icon6' => array('group' => 'blo-icons'),
					'icon icon-strategicservices_icon7' => array('group' => 'blo-icons'),
					'icon icon-strategicservices_icon8' => array('group' => 'blo-icons'),
					'icon icon-post_icon1' => array('group' => 'blo-icons'),
					'icon icon-post_icon2' => array('group' => 'blo-icons'),
					'icon icon-post_icon3' => array('group' => 'blo-icons'),
					'icon icon-post_icon4' => array('group' => 'blo-icons'),
					'icon icon-post_icon5' => array('group' => 'blo-icons'),
					'icon icon-application_icon' => array('group' => 'blo-icons'),
					'icon icon-opened_positions_icon1' => array('group' => 'blo-icons'),
					'icon icon-opened_positions_icon2' => array('group' => 'blo-icons'),
					'icon icon-about_us_icon1' => array('group' => 'blo-icons'),
					'icon icon-about_us_icon2' => array('group' => 'blo-icons'),
					'icon icon-about_us_icon3' => array('group' => 'blo-icons'),
					'icon icon-about_us_icon4' => array('group' => 'blo-icons'),
					'icon icon-About-2' => array('group' => 'blo-icons'),
					'icon icon-About-3' => array('group' => 'blo-icons'),
					'icon icon-About-4' => array('group' => 'blo-icons'),
					'icon icon-About' => array('group' => 'blo-icons'),
					'icon icon-Banner_current' => array('group' => 'blo-icons'),
					'icon icon-Banner_factory-1' => array('group' => 'blo-icons'),
					'icon icon-Banner_factory' => array('group' => 'blo-icons'),
					'icon icon-Banner_pumpjack' => array('group' => 'blo-icons'),
					'icon icon-Funfacts-2' => array('group' => 'blo-icons'),
					'icon icon-Funfacts-3' => array('group' => 'blo-icons'),
					'icon icon-Funfacts-4' => array('group' => 'blo-icons'),
					'icon icon-Funfacts' => array('group' => 'blo-icons'),
					'icon icon-mobile' => array('group' => 'blo-icons'),
					'icon icon-laptop' => array('group' => 'blo-icons'),
					'icon icon-desktop' => array('group' => 'blo-icons'),
					'icon icon-tablet' => array('group' => 'blo-icons'),
					'icon icon-phone' => array('group' => 'blo-icons'),
					'icon icon-document' => array('group' => 'blo-icons'),
					'icon icon-documents' => array('group' => 'blo-icons'),
					'icon icon-search' => array('group' => 'blo-icons'),
					'icon icon-clipboard' => array('group' => 'blo-icons'),
					'icon icon-newspaper' => array('group' => 'blo-icons'),
					'icon icon-notebook' => array('group' => 'blo-icons'),
					'icon icon-book-open' => array('group' => 'blo-icons'),
					'icon icon-browser' => array('group' => 'blo-icons'),
					'icon icon-calendar' => array('group' => 'blo-icons'),
					'icon icon-presentation' => array('group' => 'blo-icons'),
					'icon icon-picture' => array('group' => 'blo-icons'),
					'icon icon-pictures' => array('group' => 'blo-icons'),
					'icon icon-video' => array('group' => 'blo-icons'),
					'icon icon-camera' => array('group' => 'blo-icons'),
					'icon icon-printer' => array('group' => 'blo-icons'),
					'icon icon-toolbox' => array('group' => 'blo-icons'),
					'icon icon-briefcase' => array('group' => 'blo-icons'),
					'icon icon-wallet' => array('group' => 'blo-icons'),
					'icon icon-gift' => array('group' => 'blo-icons'),
					'icon icon-bargraph' => array('group' => 'blo-icons'),
					'icon icon-grid' => array('group' => 'blo-icons'),
					'icon icon-expand' => array('group' => 'blo-icons'),
					'icon icon-focus' => array('group' => 'blo-icons'),
					'icon icon-edit' => array('group' => 'blo-icons'),
					'icon icon-adjustments' => array('group' => 'blo-icons'),
					'icon icon-ribbon' => array('group' => 'blo-icons'),
					'icon icon-hourglass' => array('group' => 'blo-icons'),
					'icon icon-lock' => array('group' => 'blo-icons'),
					'icon icon-megaphone' => array('group' => 'blo-icons'),
					'icon icon-shield' => array('group' => 'blo-icons'),
					'icon icon-trophy' => array('group' => 'blo-icons'),
					'icon icon-flag' => array('group' => 'blo-icons'),
					'icon icon-map' => array('group' => 'blo-icons'),
					'icon icon-puzzle' => array('group' => 'blo-icons'),
					'icon icon-basket' => array('group' => 'blo-icons'),
					'icon icon-envelope' => array('group' => 'blo-icons'),
					'icon icon-streetsign' => array('group' => 'blo-icons'),
					'icon icon-telescope' => array('group' => 'blo-icons'),
					'icon icon-gears' => array('group' => 'blo-icons'),
					'icon icon-key' => array('group' => 'blo-icons'),
					'icon icon-paperclip' => array('group' => 'blo-icons'),
					'icon icon-attachment' => array('group' => 'blo-icons'),
					'icon icon-pricetags' => array('group' => 'blo-icons'),
					'icon icon-lightbulb' => array('group' => 'blo-icons'),
					'icon icon-layers' => array('group' => 'blo-icons'),
					'icon icon-pencil' => array('group' => 'blo-icons'),
					'icon icon-tools' => array('group' => 'blo-icons'),
					'icon icon-tools-2' => array('group' => 'blo-icons'),
					'icon icon-scissors' => array('group' => 'blo-icons'),
					'icon icon-paintbrush' => array('group' => 'blo-icons'),
					'icon icon-magnifying-glass' => array('group' => 'blo-icons'),
					'icon icon-circle-compass' => array('group' => 'blo-icons'),
					'icon icon-linegraph' => array('group' => 'blo-icons'),
					'icon icon-mic' => array('group' => 'blo-icons'),
					'icon icon-strategy' => array('group' => 'blo-icons'),
					'icon icon-beaker' => array('group' => 'blo-icons'),
					'icon icon-caution' => array('group' => 'blo-icons'),
					'icon icon-recycle' => array('group' => 'blo-icons'),
					'icon icon-anchor' => array('group' => 'blo-icons'),
					'icon icon-profile-male' => array('group' => 'blo-icons'),
					'icon icon-profile-female' => array('group' => 'blo-icons'),
					'icon icon-bike' => array('group' => 'blo-icons'),
					'icon icon-wine' => array('group' => 'blo-icons'),
					'icon icon-hotairballoon' => array('group' => 'blo-icons'),
					'icon icon-globe' => array('group' => 'blo-icons'),
					'icon icon-genius' => array('group' => 'blo-icons'),
					'icon icon-map-pin' => array('group' => 'blo-icons'),
					'icon icon-dial' => array('group' => 'blo-icons'),
					'icon icon-chat' => array('group' => 'blo-icons'),
					'icon icon-heart' => array('group' => 'blo-icons'),
					'icon icon-cloud' => array('group' => 'blo-icons'),
					'icon icon-upload' => array('group' => 'blo-icons'),
					'icon icon-download' => array('group' => 'blo-icons'),
					'icon icon-target' => array('group' => 'blo-icons'),
					'icon icon-hazardous' => array('group' => 'blo-icons'),
					'icon icon-piechart' => array('group' => 'blo-icons'),
					'icon icon-speedometer' => array('group' => 'blo-icons'),
					'icon icon-global' => array('group' => 'blo-icons'),
					'icon icon-compass' => array('group' => 'blo-icons'),
					'icon icon-lifesaver' => array('group' => 'blo-icons'),
					'icon icon-clock' => array('group' => 'blo-icons'),
					'icon icon-aperture' => array('group' => 'blo-icons'),
					'icon icon-quote' => array('group' => 'blo-icons'),
					'icon icon-scope' => array('group' => 'blo-icons'),
					'icon icon-alarmclock' => array('group' => 'blo-icons'),
					'icon icon-refresh' => array('group' => 'blo-icons'),
					'icon icon-happy' => array('group' => 'blo-icons'),
					'icon icon-sad' => array('group' => 'blo-icons'),
					'icon icon-facebook' => array('group' => 'blo-icons'),
					'icon icon-twitter' => array('group' => 'blo-icons'),
					'icon icon-googleplus' => array('group' => 'blo-icons'),
					'icon icon-rss' => array('group' => 'blo-icons'),
					'icon icon-tumblr' => array('group' => 'blo-icons'),
					'icon icon-linkedin' => array('group' => 'blo-icons'),
					'icon icon-dribbble' => array('group' => 'blo-icons'),
					'icon icon-home' => array('group' => 'blo-icons'),
					'icon icon-apartment' => array('group' => 'blo-icons'),
					'icon icon-pencil1' => array('group' => 'blo-icons'),
					'icon icon-magic-wand' => array('group' => 'blo-icons'),
					'icon icon-drop' => array('group' => 'blo-icons'),
					'icon icon-lighter' => array('group' => 'blo-icons'),
					'icon icon-poop' => array('group' => 'blo-icons'),
					'icon icon-sun' => array('group' => 'blo-icons'),
					'icon icon-moon' => array('group' => 'blo-icons'),
					'icon icon-cloud1' => array('group' => 'blo-icons'),
					'icon icon-cloud-upload' => array('group' => 'blo-icons'),
					'icon icon-cloud-download' => array('group' => 'blo-icons'),
					'icon icon-cloud-sync' => array('group' => 'blo-icons'),
					'icon icon-cloud-check' => array('group' => 'blo-icons'),
					'icon icon-database' => array('group' => 'blo-icons'),
					'icon icon-lock1' => array('group' => 'blo-icons'),
					'icon icon-cog' => array('group' => 'blo-icons'),
					'icon icon-trash' => array('group' => 'blo-icons'),
					'icon icon-dice' => array('group' => 'blo-icons'),
					'icon icon-heart1' => array('group' => 'blo-icons'),
					'icon icon-star' => array('group' => 'blo-icons'),
					'icon icon-star-half' => array('group' => 'blo-icons'),
					'icon icon-star-empty' => array('group' => 'blo-icons'),
					'icon icon-flag1' => array('group' => 'blo-icons'),
					'icon icon-envelope1' => array('group' => 'blo-icons'),
					'icon icon-paperclip1' => array('group' => 'blo-icons'),
					'icon icon-inbox' => array('group' => 'blo-icons'),
					'icon icon-eye' => array('group' => 'blo-icons'),
					'icon icon-printer1' => array('group' => 'blo-icons'),
					'icon icon-file-empty' => array('group' => 'blo-icons'),
					'icon icon-file-add' => array('group' => 'blo-icons'),
					'icon icon-enter' => array('group' => 'blo-icons'),
					'icon icon-exit' => array('group' => 'blo-icons'),
					'icon icon-graduation-hat' => array('group' => 'blo-icons'),
					'icon icon-license' => array('group' => 'blo-icons'),
					'icon icon-music-note' => array('group' => 'blo-icons'),
					'icon icon-film-play' => array('group' => 'blo-icons'),
					'icon icon-camera-video' => array('group' => 'blo-icons'),
					'icon icon-camera1' => array('group' => 'blo-icons'),
					'icon icon-picture1' => array('group' => 'blo-icons'),
					'icon icon-book' => array('group' => 'blo-icons'),
					'icon icon-bookmark' => array('group' => 'blo-icons'),
					'icon icon-user' => array('group' => 'blo-icons'),
					'icon icon-users' => array('group' => 'blo-icons'),
					'icon icon-shirt' => array('group' => 'blo-icons'),
					'icon icon-store' => array('group' => 'blo-icons'),
					'icon icon-cart' => array('group' => 'blo-icons'),
					'icon icon-tag' => array('group' => 'blo-icons'),
					'icon icon-phone-handset' => array('group' => 'blo-icons'),
					'icon icon-phone1' => array('group' => 'blo-icons'),
					'icon icon-pushpin' => array('group' => 'blo-icons'),
					'icon icon-map-marker' => array('group' => 'blo-icons'),
					'icon icon-map1' => array('group' => 'blo-icons'),
					'icon icon-location' => array('group' => 'blo-icons'),
					'icon icon-calendar-full' => array('group' => 'blo-icons'),
					'icon icon-keyboard' => array('group' => 'blo-icons'),
					'icon icon-spell-check' => array('group' => 'blo-icons'),
					'icon icon-screen' => array('group' => 'blo-icons'),
					'icon icon-smartphone' => array('group' => 'blo-icons'),
					'icon icon-tablet1' => array('group' => 'blo-icons'),
					'icon icon-laptop1' => array('group' => 'blo-icons'),
					'icon icon-laptop-phone' => array('group' => 'blo-icons'),
					'icon icon-power-switch' => array('group' => 'blo-icons'),
					'icon icon-bubble' => array('group' => 'blo-icons'),
					'icon icon-heart-pulse' => array('group' => 'blo-icons'),
					'icon icon-construction' => array('group' => 'blo-icons'),
					'icon icon-pie-chart' => array('group' => 'blo-icons'),
					'icon icon-chart-bars' => array('group' => 'blo-icons'),
					'icon icon-gift1' => array('group' => 'blo-icons'),
					'icon icon-diamond' => array('group' => 'blo-icons'),
					'icon icon-dinner' => array('group' => 'blo-icons'),
					'icon icon-coffee-cup' => array('group' => 'blo-icons'),
					'icon icon-leaf' => array('group' => 'blo-icons'),
					'icon icon-paw' => array('group' => 'blo-icons'),
					'icon icon-rocket' => array('group' => 'blo-icons'),
					'icon icon-briefcase1' => array('group' => 'blo-icons'),
					'icon icon-bus' => array('group' => 'blo-icons'),
					'icon icon-car' => array('group' => 'blo-icons'),
					'icon icon-train' => array('group' => 'blo-icons'),
					'icon icon-bicycle' => array('group' => 'blo-icons'),
					'icon icon-wheelchair' => array('group' => 'blo-icons'),
					'icon icon-select' => array('group' => 'blo-icons'),
					'icon icon-earth' => array('group' => 'blo-icons'),
					'icon icon-smile' => array('group' => 'blo-icons'),
					'icon icon-sad1' => array('group' => 'blo-icons'),
					'icon icon-neutral' => array('group' => 'blo-icons'),
					'icon icon-mustache' => array('group' => 'blo-icons'),
					'icon icon-alarm' => array('group' => 'blo-icons'),
					'icon icon-bullhorn' => array('group' => 'blo-icons'),
					'icon icon-volume-high' => array('group' => 'blo-icons'),
					'icon icon-volume-medium' => array('group' => 'blo-icons'),
					'icon icon-volume-low' => array('group' => 'blo-icons'),
					'icon icon-volume' => array('group' => 'blo-icons'),
					'icon icon-mic1' => array('group' => 'blo-icons'),
					'icon icon-hourglass1' => array('group' => 'blo-icons'),
					'icon icon-undo' => array('group' => 'blo-icons'),
					'icon icon-redo' => array('group' => 'blo-icons'),
					'icon icon-sync' => array('group' => 'blo-icons'),
					'icon icon-history' => array('group' => 'blo-icons'),
					'icon icon-clock1' => array('group' => 'blo-icons'),
					'icon icon-download1' => array('group' => 'blo-icons'),
					'icon icon-upload1' => array('group' => 'blo-icons'),
					'icon icon-enter-down' => array('group' => 'blo-icons'),
					'icon icon-exit-up' => array('group' => 'blo-icons'),
					'icon icon-bug' => array('group' => 'blo-icons'),
					'icon icon-code' => array('group' => 'blo-icons'),
					'icon icon-link' => array('group' => 'blo-icons'),
					'icon icon-unlink' => array('group' => 'blo-icons'),
					'icon icon-thumbs-up' => array('group' => 'blo-icons'),
					'icon icon-thumbs-down' => array('group' => 'blo-icons'),
					'icon icon-magnifier' => array('group' => 'blo-icons'),
					'icon icon-cross' => array('group' => 'blo-icons'),
					'icon icon-menu' => array('group' => 'blo-icons'),
					'icon icon-list' => array('group' => 'blo-icons'),
					'icon icon-chevron-up' => array('group' => 'blo-icons'),
					'icon icon-chevron-down' => array('group' => 'blo-icons'),
					'icon icon-chevron-left' => array('group' => 'blo-icons'),
					'icon icon-chevron-right' => array('group' => 'blo-icons'),
					'icon icon-arrow-up' => array('group' => 'blo-icons'),
					'icon icon-arrow-down' => array('group' => 'blo-icons'),
					'icon icon-arrow-left' => array('group' => 'blo-icons'),
					'icon icon-arrow-right' => array('group' => 'blo-icons'),
					'icon icon-move' => array('group' => 'blo-icons'),
					'icon icon-warning' => array('group' => 'blo-icons'),
					'icon icon-question-circle' => array('group' => 'blo-icons'),
					'icon icon-menu-circle' => array('group' => 'blo-icons'),
					'icon icon-checkmark-circle' => array('group' => 'blo-icons'),
					'icon icon-cross-circle' => array('group' => 'blo-icons'),
					'icon icon-plus-circle' => array('group' => 'blo-icons'),
					'icon icon-circle-minus' => array('group' => 'blo-icons'),
					'icon icon-arrow-up-circle' => array('group' => 'blo-icons'),
					'icon icon-arrow-down-circle' => array('group' => 'blo-icons'),
					'icon icon-arrow-left-circle' => array('group' => 'blo-icons'),
					'icon icon-arrow-right-circle' => array('group' => 'blo-icons'),
					'icon icon-chevron-up-circle' => array('group' => 'blo-icons'),
					'icon icon-chevron-down-circle' => array('group' => 'blo-icons'),
					'icon icon-chevron-left-circle' => array('group' => 'blo-icons'),
					'icon icon-chevron-right-circle' => array('group' => 'blo-icons'),
					'icon icon-crop' => array('group' => 'blo-icons'),
					'icon icon-frame-expand' => array('group' => 'blo-icons'),
					'icon icon-frame-contract' => array('group' => 'blo-icons'),
					'icon icon-layers1' => array('group' => 'blo-icons'),
					'icon icon-funnel' => array('group' => 'blo-icons'),
					'icon icon-text-format' => array('group' => 'blo-icons'),
					'icon icon-text-size' => array('group' => 'blo-icons'),
					'icon icon-bold' => array('group' => 'blo-icons'),
					'icon icon-italic' => array('group' => 'blo-icons'),
					'icon icon-underline' => array('group' => 'blo-icons'),
					'icon icon-strikethrough' => array('group' => 'blo-icons'),
					'icon icon-highlight' => array('group' => 'blo-icons'),
					'icon icon-text-align-left' => array('group' => 'blo-icons'),
					'icon icon-text-align-center' => array('group' => 'blo-icons'),
					'icon icon-text-align-right' => array('group' => 'blo-icons'),
					'icon icon-text-align-justify' => array('group' => 'blo-icons'),
					'icon icon-line-spacing' => array('group' => 'blo-icons'),
					'icon icon-indent-increase' => array('group' => 'blo-icons'),
					'icon icon-indent-decrease' => array('group' => 'blo-icons'),
					'icon icon-page-break' => array('group' => 'blo-icons'),
					'icon icon-hand' => array('group' => 'blo-icons'),
					'icon icon-pointer-up' => array('group' => 'blo-icons'),
					'icon icon-pointer-right' => array('group' => 'blo-icons'),
					'icon icon-pointer-down' => array('group' => 'blo-icons'),
					'icon icon-pointer-left' => array('group' => 'blo-icons'),
					'icon icon-vplay' => array('group' => 'blo-icons'),
					'icon icon-newsletter' => array('group' => 'blo-icons'),
					'icon icon-coins-2' => array('group' => 'blo-icons'),
					'icon icon-commerce-2' => array('group' => 'blo-icons'),
					'icon icon-monitor' => array('group' => 'blo-icons'),
					'icon icon-graphic-3' => array('group' => 'blo-icons'),
					'icon icon-business' => array('group' => 'blo-icons'),
					'icon icon-graphic-2' => array('group' => 'blo-icons'),
					'icon icon-commerce-1' => array('group' => 'blo-icons'),
					'icon icon-hammer' => array('group' => 'blo-icons'),
					'icon icon-graphic-1' => array('group' => 'blo-icons'),
					'icon icon-graphic' => array('group' => 'blo-icons'),
					'icon icon-justice-1' => array('group' => 'blo-icons'),
					'icon icon-line' => array('group' => 'blo-icons'),
					'icon icon-money-3' => array('group' => 'blo-icons'),
					'icon icon-chart' => array('group' => 'blo-icons'),
					'icon icon-commerce' => array('group' => 'blo-icons'),
					'icon icon-agenda' => array('group' => 'blo-icons'),
					'icon icon-money-2' => array('group' => 'blo-icons'),
					'icon icon-justice' => array('group' => 'blo-icons'),
					'icon icon-money-1' => array('group' => 'blo-icons'),
					'icon icon-money' => array('group' => 'blo-icons'),
					'icon icon-technology' => array('group' => 'blo-icons'),
					'icon icon-coins-1' => array('group' => 'blo-icons'),
					'icon icon-coins' => array('group' => 'blo-icons'),
					'icon icon-left-arrow' => array('group' => 'blo-icons'),
					'icon icon-bank' => array('group' => 'blo-icons'),
					'icon icon-calculator' => array('group' => 'blo-icons'),
					'icon icon-chart1' => array('group' => 'blo-icons'),
					'icon icon-chart2' => array('group' => 'blo-icons'),
					'icon icon-checked' => array('group' => 'blo-icons'),
					'icon icon-clock2' => array('group' => 'blo-icons'),
					'icon icon-comment' => array('group' => 'blo-icons'),
					'icon icon-comments' => array('group' => 'blo-icons'),
					'icon icon-consult' => array('group' => 'blo-icons'),
					'icon icon-consut2' => array('group' => 'blo-icons'),
					'icon icon-deal' => array('group' => 'blo-icons'),
					'icon icon-download2' => array('group' => 'blo-icons'),
					'icon icon-envelope2' => array('group' => 'blo-icons'),
					'icon icon-euro' => array('group' => 'blo-icons'),
					'icon icon-folder' => array('group' => 'blo-icons'),
					'icon icon-invest' => array('group' => 'blo-icons'),
					'icon icon-loan' => array('group' => 'blo-icons'),
					'icon icon-map-marker1' => array('group' => 'blo-icons'),
					'icon icon-mutual-fund' => array('group' => 'blo-icons'),
					'icon icon-percent' => array('group' => 'blo-icons'),
					'icon icon-phone2' => array('group' => 'blo-icons'),
					'icon icon-pie-chart1' => array('group' => 'blo-icons'),
					'icon icon-play' => array('group' => 'blo-icons'),
					'icon icon-left-arrow2' => array('group' => 'blo-icons'),
					'icon icon-savings' => array('group' => 'blo-icons'),
					'icon icon-search1' => array('group' => 'blo-icons'),
					'icon icon-tag1' => array('group' => 'blo-icons'),
					'icon icon-tags' => array('group' => 'blo-icons'),
					'icon icon-tax' => array('group' => 'blo-icons'),
					'icon icon-quote1' => array('group' => 'blo-icons'),
					'icon icon-right-arrow2' => array('group' => 'blo-icons'),
