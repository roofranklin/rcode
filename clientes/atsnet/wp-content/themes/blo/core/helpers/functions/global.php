...
// ----------------------------------------------------------------------------------------
function blo_return( $s ) {

	return wp_kses_post($s);
}

//css unit check
function blo_style_unit( $data ) {
...
// ----------------------------------------------------------------------------------------
function blo_option( $key, $default_value = '', $method = 'customizer' ) {
	if ( defined( 'FW' ) ) {
		switch ( $method ) {
			case 'theme-settings':
...
// ----------------------------------------------------------------------------------------
function blo_meta_option( $postid, $key, $default_value = '' ) {
	if ( defined( 'FW' ) ) {
...
// ----------------------------------------------------------------------------------------
function blo_resize( $url, $width = false, $height = false, $crop = false ) {
...
// ----------------------------------------------------------------------------------------
function blo_src( $key, $default_value = '', $input_as_attachment = false ) { // for src
	if ( $input_as_attachment == true ) {
		$attachment = $key;
	} else {
		$attachment = blo_option( $key );
	}
...
// ----------------------------------------------------------------------------------------
function blo_org_id( $id, $name = true ) {
...
// ----------------------------------------------------------------------------------------
function blo_google_fonts_url($font_families	 = []) {
	$fonts_url		 = '';
	/*
    Translators: If there are characters in your language that are not supported
    by chosen font(s), translate this to 'off'. Do not translate into your own language.
    */
	if ( $font_families && 'off' !== _x( 'on', 'Google font: on or off', 'blo' ) ) {
		$query_args = array(
...
// ----------------------------------------------------------------------------------------
function blo_get_mega_item_child_slug( $location, $option_id ) {
	$mega_item	 = '';
...
// ----------------------------------------------------------------------------------------
function blo_soundcloud_embed( $url ) {
...
if ( !function_exists( 'blo_advanced_font_styles' ) ) :

	/**
	 * Get shortcode advanced Font styles
	 *
	 */
	function blo_advanced_font_styles( $style ) {
...
function blo_ekit_headers($format='html'){
...
function blo_ekit_footers($format='html'){
...
function blo_ekit_headers_activate(){

    $header_settings = blo_option('header_builder_enable');
