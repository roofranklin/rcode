...
class ElementsKit_Extend_Parallax{
    ...
    public function after_section_end($control, $args)
    {
        $control->start_controls_section(
            ...
            array(
                'label' => esc_html__('Parallax Effects', 'parallax'),
        ...
        $control->add_control(
            ...
            [
                'label' => esc_html__('Background Image Parallax', 'prefix'),
        ...
        $control->add_control(
            ...
            array(
                'label' => esc_html__('Multi Item Parallax', 'prefix'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'elemenetskit'),
                'label_off' => esc_html__('Hide', 'elemenetskit'),
            )
        ...
        $repeater->add_control(
            'parallax_speed', [
                'label' => esc_html__('Speed', 'elemenetskit'),
                'type' => Controls_Manager::NUMBER,
                'default' => esc_html__('100', 'agmycoo'),
                'condition' => [
