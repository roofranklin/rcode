	...
	protected function register_controls() {
		...
		$this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::REPEATER,
                'default' => [
                    [ 'ekit_chart_data_label' => esc_html__('Label #1', 'elementskit'), 	'ekit_chart_data_set' => '13,20,15', 'ekit_chart_data_bar_back_color' => 'rgba(242,41,91,0.48)', 'ekit_chart_data_bar_border_color' => 'rgba(242,41,91,0.48)', 'ekit_chart_data_bar_border_width' => 1],
                    [ 'ekit_chart_data_label' => esc_html__('Label #2', 'elementskit'), 'ekit_chart_data_set' => '20,10,33', 'ekit_chart_data_bar_back_color' => 'rgba(69,53,244,0.48)', 'ekit_chart_data_bar_border_color' => 'rgba(69,53,244,0.48)', 'ekit_chart_data_bar_border_width' => 1 ],
                    [ 'ekit_chart_data_label' => esc_html__('Label #3', 'elementskit'), 'ekit_chart_data_set' => '10,3,23', 'ekit_chart_data_bar_back_color' => 'rgba(239,239,40,0.57)', 'ekit_chart_data_bar_border_color' => 'rgba(239,239,40,0.57)', 'ekit_chart_data_bar_border_width' => 1 ],
		...
		$this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::REPEATER,
                'default' => [
                    [ 'ekit_chart_data_label' => esc_html__('Label #1', 'elementskit'), 	'ekit_chart_data_set2' => '13', 'ekit_chart_data_bar_back_color' => 'rgba(242,41,91,0.48)', 'ekit_chart_data_bar_border_color' => 'rgba(242,41,91,0.48)', 'ekit_chart_data_bar_border_width' => 1],
                    [ 'ekit_chart_data_label' => esc_html__('Label #2', 'elementskit'), 'ekit_chart_data_set2' => '20', 'ekit_chart_data_bar_back_color' => 'rgba(69,53,244,0.48)', 'ekit_chart_data_bar_border_color' => 'rgba(69,53,244,0.48)', 'ekit_chart_data_bar_border_width' => 1 ],
                    [ 'ekit_chart_data_label' => esc_html__('Label #3', 'elementskit'), 'ekit_chart_data_set2' => '10', 'ekit_chart_data_bar_back_color' => 'rgba(239,239,40,0.57)', 'ekit_chart_data_bar_border_color' => 'rgba(239,239,40,0.57)', 'ekit_chart_data_bar_border_width' => 1 ],
		...
		$this->add_control(
			...
			[
				...
				'condition' => ['ekit_charts_grid_lines' => 'yes', 'ekit_chart_style!' => ['doughnut', 'pie', 'polarArea']]
			]
		);
				...
				if(is_array($ekit_charts_data_set) && sizeof($ekit_charts_data_set)):
					foreach($ekit_charts_data_set AS $DataChart):
						...
						$dataChartArray['datasets'][] = [
								...
								'data'  => array_map('intval', explode(',', trim( $DataChart['ekit_chart_data_set'], ',') ) ),
								'backgroundColor'  => $backgroundColor,
								'hoverBackgroundColor'  => $backgroundColorHover,
								'borderColor'  => $borderColor,
								'hoverBorderColor'  => $borderColorHover,
		...
		<script type="text/javascript">
			jQuery(document).ready(function(){
				...
				var ekitChart = new Chart(ekitChartId, {
					...
					data: {
						labels: <?php echo \ElementsKit\Utils::render($dataLabelsJson); ?>,
						datasets: <?php echo \ElementsKit\Utils::render($dataJson);?>
					},
					options: <?php echo \ElementsKit\Utils::render($opionsJson);?>
				});
			});
		</script>
	<?php
