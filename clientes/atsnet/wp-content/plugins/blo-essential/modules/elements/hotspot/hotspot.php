...
class ElementsKit_Widget_hotspot extends Widget_Base {
    ...
    public function get_url() {
        return \Blo_Modules::module_url() . 'elements/hotspot/';
    }

    public function get_dir() {
        return $this->dir = dirname(__FILE__) . '/';;
    }
    ...
    protected function register_controls() {
            ...
            [
                ...
                'options' => [
                    'tultip_style' => [
                        ...
                        'imagelarge' => $this->get_url() . 'assets/imagechoose/tooltip-style.png',
                        'imagesmall' => $this->get_url() . 'assets/imagechoose/tooltip-style.png',
                        'width' => '50%',
                    ],
                    'following_line_style' => [
                        'title' => esc_html__( 'Image style 2', 'elementskit-lite' ),
                        'imagelarge' => $this->get_url() . 'assets/imagechoose/following_line_style.png',
                        'imagesmall' => $this->get_url() . 'assets/imagechoose/following_line_style.png',
                        'width' => '50%',
                    ],
                ],
            ]
        ...
        $hotspot_point->add_responsive_control(
			...
			[
				...
				'options' => [
					'ekit_hotspot_follow_line_top auto'  => __( 'Auto', 'elementskit-lite' ),
                ...
                'description'  => __('This control is for 2nd style', 'elementskit-lite'),
        ...
        $hotspot_point->add_responsive_control(
            ...
            [
                'label'		 => esc_html__( 'Move Content', 'elementskit-lite' ),
        ...
        $this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'default' => 'media ekit-flex-row',
				'options' => [
					'media ekit-flex-column'  => __( 'Top', 'elementskit-lite' ),
					'media ekit-flex-row' => __( 'Left', 'elementskit-lite' ),
					'media ekit-flex-row-reverse' => __( 'Right', 'elementskit-lite' ),
					'media ekit-flex-column-reverse' => __( 'Bottom', 'elementskit-lite' ),
				],
			]
        );
    ...
    protected function render_raw( ) {
        ...
        <div class="ekit-location-groups">
            ...
            <?php 
                echo wp_get_attachment_image($ekit_hotspot_background_image['id'], 'full', "", 
                array( 
                "alt"   => get_the_title($ekit_hotspot_background_image['id']),
                ) );  
            ?>
            </div>
            <div class="ekit-location-wraper clearfix">
                <?php
                    ...
                    require $this->get_dir() . 'style/'.$ekit_hotspot_style_choosers.'.php';
