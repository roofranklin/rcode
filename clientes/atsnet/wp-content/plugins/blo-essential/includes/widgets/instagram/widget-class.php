...
class BLO_Instagram extends WP_Widget
{
    function __construct() {

        $widget_opt = array(
            'classname'     => 'BLO-widget',
            'description'   => 'BLO instagrams'
        );
        
        parent::__construct('BLO-instagram', esc_html__('BLO instagram', 'BLO-essential'), $widget_opt);
    }
    ...
    function form($instance){
        ...
        $user_id = '';
        $media_count = 10;
        $title = esc_html__( 'Instagram', 'BLO-essential' );
        ...
        ?>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php _e( 'Title:', 'BLO-essential' ); ?></label>
        ...
        <p>
            ...
            <?php esc_html__( 'Log in and get my Access Token and User ID' , 'BLO-essential' ); ?>
            </a>
        </p>

        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'access_token' )); ?>"><?php esc_html__( 'Access token:' , 'BLO-essential' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'user_id' )); ?>"><?php esc_html__( 'User ID:' , 'BLO-essential' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'media_count' )); ?>"><?php esc_html__( 'Count:' , 'BLO-essential' ); ?></label>
