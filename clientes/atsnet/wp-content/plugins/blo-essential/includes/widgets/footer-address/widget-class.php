...
class BLO_Footer_Address extends WP_Widget
{
    function __construct() {
        $widget_opt = array(
            'classname'     => 'BLO-footer-address',
            'description'   => esc_html__('BLO footer address','BLO-essential')
        );
        
        parent::__construct('xs-footer-address', esc_html__('BLO footer address', 'BLO-essential'), $widget_opt);
    }
    ...
    function widget( $args, $instance ){
        ...
        <div class="media xs-footer-info-and-payment">
            ...
            <div class="media-body">
                ...
                <?php endif; ?>
                <?php if($map_btn != ''): ?>
                    <a href="https://maps.google.com/maps?<?php echo wp_kses_post($query_string);?>" class="xs-map-popup btn btn-primary">
                        <?php if($map_icon != ''): ?>
    ...
    function form($instance){
    	if(isset($instance['title'])){
            ...
            $title = esc_html__( 'Footer address', 'BLO-essential' );
        }
        if(isset($instance['message'])){
            $message = $instance['message'];
        }else{
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'message' )); ?>"><?php esc_html_e( 'Message' , 'BLO-essential' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'address' )); ?>"><?php esc_html_e( 'Address:' , 'BLO-essential' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'mobile' )); ?>"><?php esc_html_e( 'Mobile:' , 'BLO-essential' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'media_icon' )); ?>"><?php esc_html_e( 'Media icon:' , 'BLO-essential' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'map_icon' )); ?>"><?php esc_html_e( 'Map icon:' , 'BLO-essential' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'map_btn' )); ?>"><?php esc_html_e( 'Map button:' , 'BLO-essential' ); ?></label>
