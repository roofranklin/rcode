...
$page_column_class = yoome_page_layout_columns_class($page_options['ts_page_layout']);
...
if( $show_breadcrumb || $show_page_title ){
	$extra_class = 'show_breadcrumb_'.yoome_get_theme_options('ts_breadcrumb_layout');
}
