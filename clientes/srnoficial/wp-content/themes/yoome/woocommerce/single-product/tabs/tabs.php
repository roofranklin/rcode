...
$is_accordion = shortcode_exists('vc_tta_accordion') && yoome_get_theme_options('ts_prod_accordion_tabs');
...
if ( ! empty( $product_tabs ) ) : ?>
	...
	<div class="woocommerce-tabs accordion-tabs">
		...
		<?php
		$active_tab = 1;
		if( yoome_get_theme_options('ts_prod_tabs_position') == 'inside_summary' ){
			$active_tab = 0;
		}
