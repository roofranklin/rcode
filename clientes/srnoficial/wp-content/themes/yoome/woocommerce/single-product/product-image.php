...
<div class="images-thumbnails">
	...
	<?php
		...
		do_action('yoome_before_product_image');
		...
		if ( has_post_thumbnail() ) {
			...
			$html .= sprintf( '<img src="%s" alt="%s" class="wp-post-image" />', esc_url( wc_placeholder_img_src() ), esc_html__( 'Awaiting product image', 'yoome' ) );
			$html .= '</div>';
		}
