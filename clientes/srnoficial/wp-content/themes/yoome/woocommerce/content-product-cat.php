		...
		<div class="meta-wrapper">
			...
			<div class="category-name">
				...
				if ( $show_cat_product_count ){
					echo apply_filters( 'woocommerce_subcategory_count_html', '<div class="count">' . sprintf( _n( '%s Product', '%s Products', $category->count, 'yoome' ), $category->count ) . '</div>', $category );
				}
				?>
			</div>
			...
			<div class="button">
				<a href="<?php echo esc_url($term_link) ?>" class="shop-now-button button">
