...
?>
	<div class="ts-blogs related-posts related nav-middle middle-thumbnail ts-slider <?php echo esc_attr($is_slider?'loading':''); ?>">
		<header class="theme-title">
			<h3 class="heading-title"><?php esc_html_e('Related Posts', 'yoome'); ?></h3>
		</header>
				...
				<article class="item <?php echo esc_attr($post_format); ?>">
					<div class="article-content">
						...
						<div class="entry-content <?php echo !$show_thumbnail?'no-featured-image':'' ?>">
							...
							<div class="entry-meta-top">
								...
								<div class="meta-right">
									...
									<span class="comment-count">
										<span class="number">
											<?php echo yoome_get_post_comment_count(); ?>
										</span>
									</span>
								</div>
							...
							<div class="excerpt"><?php yoome_the_excerpt_max_words(18, '', true, '', true); ?></div>
							
							<div class="entry-meta-bottom">
								<!-- Blog Read More Button -->
								<a class="button-readmore button-text" href="<?php the_permalink() ; ?>"><?php esc_html_e('Read More', 'yoome'); ?></a>
