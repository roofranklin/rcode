...
$args = array(
	...
	'menu_title'           => esc_html__( 'Theme Options', 'yoome' ),
	'page_title'           => esc_html__( 'Theme Options', 'yoome' ),
	...
	'global_variable'      => 'yoome_theme_options',
...
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'General', 'yoome' )
	,'id'               => 'general-tab'
	,'desc'             => ''
	,'icon'             => 'el el-home'
...
/*** Color Scheme Tab ***/
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'Color Scheme', 'yoome' )
	,'id'               => 'color-scheme-tab'
	,'desc'             => ''
	,'icon'             => 'el el-brush'
...
/*** Typography Tab ***/
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'Typography', 'yoome' )
	,'id'               => 'typography-tab'
	,'desc'             => ''
	,'icon'             => 'el el-font'
...
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'Portfolio Details', 'yoome' )
	,'id'               => 'portfolio-details-tab'
	,'desc'             => ''
	,'icon'             => 'el el-picture'
	,'fields'           => $option_fields['portfolio-details']
) );

/*** WooCommerce Tab ***/
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'WooCommerce', 'yoome' )
	,'id'               => 'woocommerce-tab'
	,'desc'             => ''
...
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'Shop/Product Category', 'yoome' )
...
/*** Product Details Tab ***/
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'Product Details', 'yoome' )
...
/*** Custom Code Tab ***/
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'Custom Code', 'yoome' )
	,'id'               => 'custom-code-tab'
	,'desc'             => ''
	,'icon'             => 'el el-edit'
