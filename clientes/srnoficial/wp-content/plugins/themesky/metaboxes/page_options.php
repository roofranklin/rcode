<?php
$options = array();
$default_sidebars = function_exists('yoome_get_list_sidebars')? yoome_get_list_sidebars(): array();
...
$footer_blocks = function_exists('yoome_get_footer_block_options')? yoome_get_footer_block_options(): array();
...
$options[] = array(
				'id'		=> 'logo_mobile_menu'
				,'label'	=> esc_html__('Mobile Menu Logo', 'themesky')
				,'desc'		=> esc_html__('Display this logo on the top of mobile menu', 'themesky')
				,'type'		=> 'upload'
			);			
...
$options[] = array(
				'id'		=> 'first_footer_area'
				,'label'	=> esc_html__('First Footer Area', 'themesky')
				,'desc'		=> ''
				,'type'		=> 'select'
...
$options[] = array(
				'id'		=> 'second_footer_area'
				,'label'	=> esc_html__('Second Footer Area', 'themesky')
				,'desc'		=> ''
				,'type'		=> 'select'
				,'options'	=> $footer_blocks
			);
