 ...
 * Description: Add shortcodes and custom post types for the Yoome Theme
 * Version: 1.0.5
 * Author: ThemeSky Team
 * Author URI: http://theme-sky.com
 */
if( !defined('THEMESKY_VERSION') ){
	define('THEMESKY_VERSION', '1.0.5');
}
...
class ThemeSky_Plugin{
	...
	function include_files(){
		...
		require_once('class-post-like.php');
	...
	function register_widgets(){
		$file_names = array('single_image', 'twitter', 'mailchimp_subscription', 'product_filter_by_color', 'product_filter_by_availability'
							...
							, 'facebook_page', 'flickr', 'instagram', 'product_categories', 'menu');
